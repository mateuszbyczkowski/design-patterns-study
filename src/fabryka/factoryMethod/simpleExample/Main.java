...
public class Main {
    public static void main(String[] args) {
        ...
        factory.doAction("round"); //zostaną wykonane operacje na utworzonym obiekcie PolishRoundProduct

        factory = new GermanProductProcess();
        factory.doAction("square"); //zostaną wykonane operacje na utworzonym obiekcie GermanSquareProduct
    }
}
